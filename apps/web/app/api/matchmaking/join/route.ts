// ===== FILE START: apps/web/app/api/matchmaking/join/route.ts =====
...
export async function POST(req: Request) {
  try {
    ...
    const upstream = await fetch(`${apiBase}/matchmaking/join`, {
      method: "POST",
...
// ===== FILE END: apps/web/app/api/matchmaking/join/route.ts =====